...
public class JobofferController {
	...
	@RequestMapping(value = "searchjobseeker.se", method = RequestMethod.GET)
	public String searchjobseeker(Locale locale, Model model) {
		System.out.println("구직자 리스트 페이지1");
