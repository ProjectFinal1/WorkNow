...
<div id="modal" style="visibility:hidden;background-color:#888888;position:absolute;display:none;left:0;top:0;z-index:9000;opacity:0.92;">
 <div class="container" >
        <div id="signupContent" class="card card-container" style="max-width:800px;height:300px;margin-top:13%;text-align:center;">
            ...
            <div id="per" style="display:none;">
            	 <div class="container">
	<div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm" style="width:40%;margin-top:3%">
            <legend>
